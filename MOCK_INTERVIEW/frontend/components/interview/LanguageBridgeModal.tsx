...
export default function LanguageBridgeModal({
  ...
  const totalScore = evaluationResult.totalScore;
  const isLowScore = totalScore < 8;
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-300">
      <div className="bg-white border border-slate-200 rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl space-y-6 relative overflow-hidden text-slate-900">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <select
              ...
              className="text-xs font-semibold bg-white border border-slate-200 rounded-xl px-3 py-1.5 text-slate-800 focus:outline-none focus:border-orange-500 transition-all"
            >
          ...
          <div className="relative">
            <textarea
              ...
              placeholder="Explain your thought process naturally in your native language (e.g. Hindi, Marathi, Tamil)... Sarvam AI will convert it to professional technical English."
              className="w-full p-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-orange-500 transition-all resize-none"
            />
            ...
            <div className="absolute bottom-3 right-3 flex items-center gap-2">
              {isRecording ? (
                <button
                  ...
                  className="px-3 py-1.5 bg-rose-500 hover:bg-rose-600 text-white rounded-xl text-xs font-semibold flex items-center gap-1.5 animate-pulse shadow-sm"
                >
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-semibold flex items-center gap-1.5 shadow-sm transition-all"
                >
          ...
          <button
            ...
            className="w-full py-2.5 bg-orange-500 hover:bg-orange-600 disabled:opacity-50 text-white text-xs font-bold rounded-xl flex items-center justify-center gap-2 transition-all shadow-md"
          >
            {isTranslating ? (
              <>
        ...
        {assistedResult && (
          <div className="bg-orange-50/50 border border-orange-200/80 rounded-2xl p-4 space-y-3 animate-in fade-in duration-300">
            ...
            <p className="text-xs font-medium text-slate-800 leading-relaxed bg-white p-3 rounded-xl border border-orange-100 shadow-2xs">
            ...
            <div className="pt-2 flex justify-end">
              <button
                ...
                className="px-4 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-bold flex items-center gap-2 shadow-md transition-all"
              >
